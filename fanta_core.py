# VERSIONE v3.25.0 FANTAMOSSA - MULTIPAGE CORE
...
st.markdown(
    f"""<div class="fm-head">
      ...
      <div class="fm-brandbox"><div class="fm-brand">FantaMossa</div><div class="fm-sub">FC Jigen • Asta 2026/27 • v3.25.0 MULTIPAGE</div></div>
...
with st.sidebar:
    ...
    st.caption("Controlli rapidi • v3.25.0")
