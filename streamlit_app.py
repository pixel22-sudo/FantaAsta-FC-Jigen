# VERSIONE v3.31.0 FANTAMOSSA - POST ASTA VERIFIED + STABLE
...
with st.sidebar:
    ...
    st.caption("Controlli rapidi • v3.31.0")
...
# v3.31.0 — Navigazione stabile post-asta, senza callback/fragment/Mossa.
nav_options = ["🔥 Asta","👕 Rosa","👥 Rivali","••• Altro"]
main_nav = st.segmented_control(
    "Navigazione", nav_options,
    default="👕 Rosa" if len(S.get("roster", [])) >= 25 else "🔥 Asta",
