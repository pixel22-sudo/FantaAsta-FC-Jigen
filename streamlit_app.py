# VERSIONE v3.21 FANTAMOSSA - BOTTOM NAV IPHONE
...
st.markdown("""
<style>
/* v3.21 — MENU PRINCIPALE FISSO IN BASSO */
.st-key-fm_main_nav{
    ...
    margin:0 !important;
    background:rgba(5,35,28,.98) !important;
    border:1px solid rgba(216,183,95,.32) !important;
    border-radius:22px !important;
    box-shadow:0 8px 24px rgba(0,0,0,.28) !important;
}
.st-key-fm_main_nav div[role="radiogroup"]{
...
.st-key-fm_main_nav button[aria-checked="true"]{
    background:rgba(216,183,95,.16) !important;
    box-shadow:inset 0 -3px 0 #D8B75F !important;
}
.st-key-fm_main_nav button[aria-checked="true"] p{
    color:#F6E3A9 !important;
}
.st-key-fm_main_nav button:hover{
    background:rgba(255,255,255,.04) !important;
}
/* spazio per non coprire il contenuto */
.block-container{
    padding-bottom:calc(7.0rem + env(safe-area-inset-bottom, 0px)) !important;
}
