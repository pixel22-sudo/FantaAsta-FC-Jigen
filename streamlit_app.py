...
st.markdown(
    f"""<div class="jigen-head">
      <div class="jigen-brand">⚽ FC Jigen • v3.7 iPHONE MATCH</div>
...
with tabs[0]:
    ...
    qa,qb=st.columns(2)
    qa.button("☁️ SALVA",use_container_width=True,on_click=_quick_cloud_save)
    qb.button("↩️ ANNULLA",use_container_width=True,on_click=_quick_undo,
